(function () {
   ...
   */
    customElements.define("datetime-picker", class TimePicker extends HTMLElement {
        ...
        _render() {
            ...
            let html = `
                <style>td{text-align:center;} .input-group{display:flex;padding-right: 20px;padding-bottom: 20px;}.input-group-addon{width:inherit;}>
